...
Saya adalah bot yang dapat membantu Anda mengelola group.
Gunakan /help untuk melihat fitur-fitur Saya.

Saya bisa melakukan apa saja, Seperti :

▶ Membisukan Anggota Group.         
▶ Mengeluarkan Anggota Group.
▶ Menyimpan Notes.   
▶ Dan banyak hal lainnya.

Klik tombol di bawah untuk menambahkan saya ke Group.
"""
...
Perintah yang tersedia:
 ⇝ /start: Untuk mengecek apakah Saya aktif.
 ⇝ /help: Untuk mendapatkan bantuan.

 \nKlik tombol di bawah untuk mendapatkan bantuan tentang kegunaannya."""
...
*SUPPORT USERS*
⇝ /gban <userid>: Untuk mengeluarkan pengguna secara global.
⇝ /ungban <userid>: Untuk membuka larangan pengguna yang telah dikeluarkan.
⇝ /gbanlist: Untuk melihat list pengguna yang dilarang secara global."""
