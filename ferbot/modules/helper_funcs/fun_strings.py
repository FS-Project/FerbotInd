...
AFKRPL = (
    "<b>{}</b> sedang istirahat sekarang",
    "<b>{}</b> jika kamu ada perlu silahkan tinggalkan pesan!",
    "{} jangan diganggu! Dia sedang istirahat",
    "Kamu sedang berbicara dengan {}, dia tidak tersedia sekarang!",
    "{} sedang offline sekarang!",
)
