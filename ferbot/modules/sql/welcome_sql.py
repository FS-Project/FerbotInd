...
from ferbot.modules.helper_funcs.msg_types import Types
from ferbot.modules.sql import BASE, SESSION
...
DEFAULT_WELCOME = "Hallo {first}, apa kabar mu?"
DEFAULT_GOODBYE = "Selamat tinggal, sehat selalu!"
